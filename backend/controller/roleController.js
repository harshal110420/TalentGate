...
const createRole = asyncHandler(async (req, res) => {
  const { role_name, displayName, isActive = true } = req.body;
  ...
  const role = await Role.create({ role_name, displayName, isActive });
...
const updateRole = asyncHandler(async (req, res) => {
  ...
  const { role_name, displayName, isActive } = req.body;
